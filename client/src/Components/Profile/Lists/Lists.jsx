          ...
          <div className={module.picks}>
            ...
            <div className={module.follow_recomand}>
                ...
                <div className={module.rec_card}>
                    <img src="https://images.unsplash.com/photo-1676918555344-e8e8f9ba410d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80" alt="" />
                    <div className="desc">
                        <h4>Alvin One</h4>
                        <h6>Lorem ipsum dolor, sit amet consectt, quisquam.</h6>
                    </div>
                    <button className={`${module.new_list_btn} ${module.follow_btn}`}>follow</button>
                </div>
                <div className={module.rec_card}>
                    <img src="https://images.unsplash.com/photo-1676918555344-e8e8f9ba410d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80" alt="" />
                    <div className="desc">
